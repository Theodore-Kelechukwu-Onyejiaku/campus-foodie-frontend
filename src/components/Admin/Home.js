    ...
    return(
        <div id="test1" className="col s12">
            ...
            <div>
                ...
                <div className="col s12 m6">
                    <div className="col s12 m6" style={{width:"100%", margin:"auto",textAlign:"center"}}>
                        <NavLink to="/admin/users" className="btn-large waves-effect waves-light action-btn" >
            ...
            <div className="row">
                <div className="col s12 m6 ">
                    <div className="col s12 m6" style={{width:"100%", margin:"auto",textAlign:"center"}}>
                        <NavLink to="/admin/add-product" className="btn-large waves-effect waves-light action-btn" >Products<span class="badge-info">{result.dishes}</span> </NavLink>
                        <p></p>
                    </div>
                </div>
                <div className="col s12 m6">
