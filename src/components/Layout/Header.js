  ...
  return (
    <>
      <nav>
        <div className="nav-wrapper">
          ...
          <ul id="nav-mobile" className="right hide-on-med-and-down">
            <li><NavLink activeClassName="active-link" to="/login"><i className="material-icons white-text left"><i class="fa fa-sign-in"></i></i>Login</NavLink></li>
            <li><NavLink activeClassName="active-link" to="/earn"><i className="material-icons left">attach_money</i>Earn</NavLink></li>
            <li>
              <NavLink activeClassName="active-link" to="/cart-list"><i className="material-icons left">shopping_cart</i>0</NavLink>
            </li>
      ...
      <ul className="sidenav" id="mobile-demo">
        <li><NavLink to="/login" className="side-link"><i className="material-icons white-text left"><i class="fa fa-sign-in"></i></i>Login</NavLink></li>
